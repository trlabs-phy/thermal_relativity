...
# Description:
# ------------
# This file orchestrates a complete end-to-end execution of the
# Unified Thermal Relativity Boltzmann Solver.
#
# It performs a single forward evolution of the system from an
# initial backsolved boundary state, records the full causal
# history, and applies vertical certification tests in one and
# three spatial dimensions.
#
# This file introduces no physical dynamics of its own.
# All evolution is performed exclusively by the history module.
# All certification routines operate in read-only mode on the
# recorded history.
#
# Governing role:
# ---------------
# - Defines global run limits and configuration
# - Backsolves the unique initial ordering boundary (once)
# - Executes the single solver loop over the ordering coordinate
# - Records the complete causal history
# - Applies 1D and 3D certification suites
# - Persists certification outputs in machine- and human-readable form
#
# Architectural guarantees:
# --------------------------
# - Single causal loop (no nested evolution)
# - No parameter fitting or runtime tuning
# - No feedback from certification into evolution
# - Deterministic and fully auditable execution
#
# ============================================================
